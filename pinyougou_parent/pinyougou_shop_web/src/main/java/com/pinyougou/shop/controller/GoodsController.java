...
public class GoodsController {
	 ...
	 * @return
	 */
	@RequestMapping("/updateIsMarketAble/{status}/{selectIds}")
	public Result updateIsMarketAble(@PathVariable("status") String status,@PathVariable("selectIds") Long[] selectIds){
		try {
			goodsService.updateIsMarketAble(status,selectIds);  //0.5s
