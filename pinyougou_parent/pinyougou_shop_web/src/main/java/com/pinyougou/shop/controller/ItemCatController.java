...
public class ItemCatController {
	 ...
	 * @return
	 */
	@RequestMapping("/findByParent/{pid}")
	public List<TbItemCat> findByParent(@PathVariable("pid") Long pid){			
		return itemCatService.findByParent(pid);
	}
	/**
	 * 返回全部列表
	 * @return
	...
	public PageResult search(@RequestBody TbItemCat itemCat, @PathVariable("pageNum") int pageNum,@PathVariable("pageSize") int pageSize ){
