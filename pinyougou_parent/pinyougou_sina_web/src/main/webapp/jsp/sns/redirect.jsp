	...
	function redirect() {
		...
		if (retUrl != null && retUrl != "-1") {
			document.getElementById("msgDiv").style.display = "block";
			 ...
			 if("${retUrl}"!=""){
					location.href ="http://localhost:8083/index.html";
					window.close();
			}	 
			...
			//var addr="";
			if(!flag){ 
				window.opener.location.href ="http://localhost:9980/sinalogin/sns?t=sina";
				window.close();
			} else{
			/* 	http://localhost:9980/jsp/sns/redirect.jsp?code=06fe140ccfdd4fe44cd4174046d5d808 */
				location.href ="http://localhost:9980/sinalogin/callback/sina?code=${param.code}";
